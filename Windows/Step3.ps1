...
$VC_redist_Filename = [System.IO.Path]::GetFileName(([System.Uri]$VC_redist_DDL).AbsolutePath)
$VC_redist_SavePath = [System.IO.Path]::Combine($env:TEMP, $VC_redist_Filename)
