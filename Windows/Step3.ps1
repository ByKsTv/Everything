...
Write-Host 'Step3: Setting UI: Applying Colors' -ForegroundColor green -BackgroundColor black
Clear-Host
...
Write-Host 'Step3: Task Scheduler: Initiating next step' -ForegroundColor green -BackgroundColor black
$NextStep = 'Step4'
