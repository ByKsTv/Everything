Write-Host 'Services: Setting to manual' -ForegroundColor green -BackgroundColor black
...
Write-Host 'Indexing Service: Disabling' -ForegroundColor green -BackgroundColor black
...
Write-Host 'Bing Search: Disabling' -ForegroundColor green -BackgroundColor black
