...
Write-Host 'Step2: Setting UI: Setting Colors' -ForegroundColor green -BackgroundColor black
$host.UI.RawUI.BackgroundColor = 'black'
$Host.UI.RawUI.ForegroundColor = 'white'

Write-Host 'Step2: Setting UI: Maximizing Window' -ForegroundColor green -BackgroundColor black
