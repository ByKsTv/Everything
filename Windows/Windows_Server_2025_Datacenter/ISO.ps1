...
$Windows_DDL1 = Invoke-WebRequest -UseBasicParsing -Uri 'https://massgrave.dev/windows_server_links' | Select-Object -ExpandProperty 'Links' | Where-Object { $_.outerHTML -match 'en-us' } | Select-Object -First 1 | Select-Object -ExpandProperty 'href'
