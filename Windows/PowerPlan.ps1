...
Write-Host 'PowerPlan: hard disk turn off hard disk after 0%' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: wireless adapter settings power saving mode maximum performance' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: sleep after 0%' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: hibernate after' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: minimum processor state 100%' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: turn off display after 0%' -ForegroundColor green -BackgroundColor black
...
Write-Host 'PowerPlan: critical battery notification off' -ForegroundColor green -BackgroundColor black
