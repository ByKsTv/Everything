...
(New-Object System.Net.WebClient).DownloadFile("https://raw.githubusercontent.com/ByKsTv/Everything/main/Windows/Windows_11_IoT_Enterprise_LTSC_2024/$NextStep_TaskName.ps1", "$env:TEMP\$NextStep_TaskName.ps1")
