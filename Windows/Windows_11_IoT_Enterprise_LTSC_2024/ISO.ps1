...
$Windows_DDL1 = ((Invoke-WebRequest -UseBasicParsing -Uri 'https://massgrave.dev/windows_ltsc_links').Links | Where-Object { $_.outerHTML -match 'en-us' -and $_.outerHTML -match 'x64' -and $_.outerHTML -match 'ENTERPRISES' } | Select-Object -First 1).href
