...
$Windows_DDL1 = Invoke-WebRequest -UseBasicParsing -Uri 'https://massgrave.dev/windows_ltsc_links' | Select-Object -ExpandProperty 'Links' | Where-Object { $_.outerHTML -match 'en-us' -and $_.outerHTML -match 'x64' -and $_.outerHTML -match 'ENTERPRISES' } | Select-Object -First 1 | Select-Object -ExpandProperty 'href'
...
if ($USB_Unattend_Drive) {
    $USB_Unattend_DDL = 'https://raw.githubusercontent.com/ByKsTv/Everything/main/Windows/Windows_11_IoT_Enterprise_LTSC_2024/autounattend.xml'
