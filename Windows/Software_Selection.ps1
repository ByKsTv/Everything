...
$Form_SoftwareSelection.width = 800
...
$CheckBox_Size_Y = 20
$CheckBox_Right_X_Axis = (($Form_SoftwareSelection.width / 2) + 20)
$CheckBox_Right_Y_Axis = 20
$CheckBox_Right_Size_X = ($Form_SoftwareSelection.width / 2)
$CheckBox_Right_Size_Y = 20
...
$Form_SoftwareSelection_OK.Location = New-Object System.Drawing.Size((($Form_SoftwareSelection.Width) / 4 ), (($Form_SoftwareSelection.height) - 100))
...
$Form_SoftwareSelection_Cancel.Location = New-Object System.Drawing.Size((($Form_SoftwareSelection.Width) / 2 ), (($Form_SoftwareSelection.height) - 100))
