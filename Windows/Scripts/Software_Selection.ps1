...
$List = @(
    ...
    @{
        Name    = 'MSYS2'
        Tooltip = "Downloads and Installs the latest version of 'MSYS2'.`nAdds a scheduled task that will auto-update the software once windows starts.`nAdds the software to PATH."
        Icon64  = ''
    },
    @{
        Name    = 'Mullvad'
...
if (Get-ScheduledTask -TaskName $TaskName -ErrorAction SilentlyContinue) {
    $CheckBoxes['MSYS2'].Enabled = $false
    $CheckBoxes['MSYS2'].Text += ' (Installed)'
}
...
if ($Form.ShowDialog() -eq [Windows.Forms.DialogResult]::OK) {
    ...
    if ($CheckBoxes['Iriun'].Checked) {
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/ByKsTv/Everything/main/Windows/Software/Iriun/Download.ps1')
    }
    ...
    if ($CheckBoxes['MSYS2'].Checked) {
        Invoke-Expression (New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/ByKsTv/Everything/main/Windows/Software/MSYS2/Download.ps1')
    }
