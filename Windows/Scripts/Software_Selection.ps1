...
$List = @(
    ...
    @{
        Name    = 'BetterDiscord'
        Tooltip = "Downloads and Installs the latest version of 'Battle.net' with pre-selected plugins and themes.`nAdds a scheduled task that will auto-update the software once windows starts."
