...
# Settings: System: Storage: Storage Sense: Run Storage Sense: During low free disk space
...
# Settings: System: Storage: Storage Sense: Delete files in my recycle bin if they have been there for over: Never
