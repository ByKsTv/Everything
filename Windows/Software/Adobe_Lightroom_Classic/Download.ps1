...
$Lightroom_Form.FormBorderStyle = [Windows.Forms.FormBorderStyle]::FixedDialog
...
$Lightroom_Form_OK.DialogResult = [Windows.Forms.DialogResult]::OK
...
if ($Lightroom_Form.ShowDialog() -eq [Windows.Forms.DialogResult]::OK) {
