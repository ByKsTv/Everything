...
$Source = (Invoke-WebRequest -UseBasicParsing -Uri 'https://w17.monkrus.ws/search/label/Lightroom').Links | Where-Object { $_.outerHTML -notmatch '#more' -and $_.outerHTML -match 'Classic' }
