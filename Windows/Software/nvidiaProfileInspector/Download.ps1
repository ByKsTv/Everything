...
$nvidiaProfileInspector_FileName = 'nvidiaProfileInspector.exe'
$nvidiaProfileInspector_FilePath = Get-ChildItem -Path $ExtractPath -Filter $nvidiaProfileInspector_FileName | Select-Object -ExpandProperty FullName
...
$nvidiaProfileInspector_Argument = '-silent'
[Console]::BackgroundColor = 'Black'; [Console]::ForegroundColor = 'Green'; [Console]::Write('Running '); [Console]::ForegroundColor = 'Yellow'; [Console]::Write("'$nvidiaProfileInspector_FileName'"); [Console]::ForegroundColor = 'Green'; [Console]::Write(' from '); [Console]::ForegroundColor = 'Yellow'; [Console]::Write("'$nvidiaProfileInspector_FilePath'"); [Console]::ForegroundColor = 'Green'; [Console]::Write(' with '); [Console]::ForegroundColor = 'Yellow'; [Console]::Write("'$Settings_FilePath $nvidiaProfileInspector_Argument'"); [Console]::ResetColor(); [Console]::WriteLine()
Start-Process -FilePath $nvidiaProfileInspector_FilePath -ArgumentList $Settings_FilePath, $nvidiaProfileInspector_Argument -Wait