...
$Discord_IndexJS = (Get-ChildItem "$env:LOCALAPPDATA\Discord\app*\modules\discord_desktop_core-1\discord_desktop_core" -Directory | Sort-Object -Descending | Select-Object -First 1).FullName + '\index.js'
