# Group Policy: User Configuration: Administrative Templates: Microsoft Office 2016: Privacy: Trust Center: Accept all EULAS: Enabled
Set-Policy -Scope User -Path 'SOFTWARE\Policies\Microsoft\Office\16.0\registration' -Name 'acceptalleulaspolicy' -Type DWORD -Value 1
