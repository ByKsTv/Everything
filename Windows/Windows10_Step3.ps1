...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/ByKsTv/Everything/Windows/master/$Windows10Step4.ps1 -OutFile $env:TEMP\$Windows10Step4.ps1
...
Invoke-WebRequest -Uri https://raw.githubusercontent.com/ByKsTv/Everything/Windows/master/Windows10_Step3_DesktopProfile.json -OutFile $env:TEMP\DesktopProfile.json
