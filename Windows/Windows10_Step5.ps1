...
if ((Test-Path -LiteralPath "${env:ProgramFiles(x86)}\Mozilla Firefox") -eq $true) {
	...
	Write-Host "Adding 'Set-Window' Function" -ForegroundColor green -BackgroundColor black
	# ===========================================================================
	# Set-Window.ps1 ----------------------------------------------------------
	# ===========================================================================
...
'@
	...
	Write-Host "Adding '[Clicker]' Function" -ForegroundColor green -BackgroundColor black
	$cSource = @'
using System;
