...
if (($null -eq $DotNET6_Installed) -or ($DotNET6_Installed -notmatch $DotNET6_Latest) -and ($DotNET6_EOL -ne 'eol') -and ($DotNET6_EOL -eq 'active')) {
	...
	Write-Host ".NET: Installing .NET SDK $DotNET6_Latest" -ForegroundColor green -BackgroundColor black
...
if (($null -eq $DotNET7_Installed) -or ($DotNET7_Installed -notmatch $DotNET7_Latest) -and ($DotNET7_EOL -ne 'eol') -and ($DotNET7_EOL -eq 'active')) {
	Write-Host ".NET: Downloading .NET SDK $DotNET7_Latest" -ForegroundColor green -BackgroundColor black
	...
	Write-Host ".NET: Installing .NET SDK $DotNET7_Latest" -ForegroundColor green -BackgroundColor black
...
if (($null -eq $DotNET8_Installed) -or ($DotNET8_Installed -notmatch $DotNET8_Latest) -and ($DotNET8_EOL -ne 'eol') -and ($DotNET8_EOL -eq 'active')) {
	Write-Host ".NET: Downloading .NET SDK $DotNET8_Latest" -ForegroundColor green -BackgroundColor black
	...
	Write-Host ".NET: Installing .NET SDK $DotNET8_Latest" -ForegroundColor green -BackgroundColor black
...
if (($null -eq $DotNET9_Installed) -or ($DotNET9_Installed -notmatch $DotNET9_Latest) -and ($DotNET9_EOL -ne 'eol') -and ($DotNET9_EOL -eq 'active')) {
	Write-Host ".NET: Downloading .NET SDK $DotNET9_Latest" -ForegroundColor green -BackgroundColor black
	...
	Write-Host ".NET: Installing .NET SDK $DotNET9_Latest" -ForegroundColor green -BackgroundColor black
