...
if ((Test-Path -LiteralPath 'HKLM:\Software\Microsoft\WcmSvc\wifinetworkmanager\config') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\LocationAndSensors') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\CloudContent') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\InputPersonalization') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\CurrentVersion\PushNotifications') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\AppV\CEIP') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\DeviceInstall\Settings') -ne $true) {
    New-Item 'HKLM:\Software\Policies\Microsoft\Windows\DeviceInstall\Settings' -Force 
}
if ((Test-Path -LiteralPath 'HKLM:\System\DriverDatabase\Policies\Settings') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\HandwritingErrorReports') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\SQMClient\Windows') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\PCHealth\HelpSvc') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\PCHealth\ErrorReporting') -ne $true) {
    New-Item 'HKLM:\Software\Policies\Microsoft\PCHealth\ErrorReporting' -Force 
}
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\Windows Error Reporting') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\SearchCompanion') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Messenger\Client') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\TabletPC') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\System') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\AdvertisingInfo') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\AppCompat') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\DataCollection') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\DataCollection') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\EdgeUI') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\Maps') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Assistance\Client\1.0') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\TextInput') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\Windows') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\PCHealth\ErrorReporting\DW') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Microsoft\Windows\CurrentVersion\Policies\MobilityCenter') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows Defender\Spynet') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKLM:\Software\Policies\Microsoft\Windows\GameDVR') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\WindowsCopilot') -ne $true) {
...
if ((Test-Path -LiteralPath 'HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Explorer') -ne $true) {
