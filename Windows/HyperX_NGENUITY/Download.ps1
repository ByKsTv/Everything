Write-Host 'HyperX NGENUITY > Get latest' -ForegroundColor green -BackgroundColor black
...
Write-Host 'HyperX NGENUITY > Download' -ForegroundColor green -BackgroundColor black
...
Write-Host 'HyperX NGENUITY > Install' -ForegroundColor green -BackgroundColor black
